...
<h2>Live link 🌍📡 - [  https://justiceagbonma.com  ]</h2>
<hr/>


<img width='100%' src='https://res.cloudinary.com/isreal/image/upload/v1702741004/My%20portfolio%20Project/Screenshot_2023-12-16_at_10.35.25_tswkia.png' />
...
## My Aim 📚 
<br/>
1️⃣ A seamless and interactive personal website to display my bio, skill, interest, testnology stack and projects.<br/>
2️⃣ A platform to allow prospective recruiters and client have a graphiv list and display of my works and projects
<br/>
<br/>
<img width='100%' src='https://res.cloudinary.com/isreal/image/upload/v1702741004/My%20portfolio%20Project/Screenshot_2023-12-16_at_10.35.25_tswkia.png' />
...
## System Architecture 🏰
<br/>
☝ My portfolio website consists of three main components:  <br/>
The front end, the back end, and the database. The platform follows a client-server architecture, with the front end serving as the client and the back end and database serving as the server.

🎨 Front-end  <br/>
The front end of the platform is built using NextJS and TypeScript, which is a popular JavaScript library for building user interfaces. NextJS allows for the creation of dynamic and responsive user interfaces also **Loading Skeleton**, which are critical for providing an engaging UI experience to visitors. The front end communicates with the back end using RESTful API calls.
...
#### The front end of my portfolio website has all the necessary components that an portfolio platform should have. Some of these pages components are: 

For Students:
- **Homepage 🏠:** A picture of me and my full name wriiten in full.
- **About 📚:** A brief introduction about me and my academy background along side statistic of acheivements.
- **Skill 💡:** My skill set listing out technologies i am proficient and and have experience working with.
- **Projects 🛒 :** Projects i have worked on and collaborated in a team.
- **Review 🎓:** Review from friends , colleagues and clients.
- **Message 👤:** Input box for message and review from visitors.
- **footer ✏️:** Contact details and social handles.
...
# About Page
<img width='100%' src='https://res.cloudinary.com/isreal/image/upload/v1702743410/My%20portfolio%20Project/Screenshot_2023-12-16_at_11.16.12_hgawj3.png' />

# Skill Page
<img width='100%' src='https://res.cloudinary.com/isreal/image/upload/v1702743527/My%20portfolio%20Project/Screenshot_2023-12-16_at_11.18.20_abvddo.png' />

# Portfolio Page
<img width='100%' src='https://res.cloudinary.com/isreal/image/upload/v1702743611/My%20portfolio%20Project/Screenshot_2023-12-16_at_11.19.29_eelt6j.png' />

# Review
<img width='100%' src='https://res.cloudinary.com/isreal/image/upload/v1702743672/My%20portfolio%20Project/Screenshot_2023-12-16_at_11.20.41_csnuas.png' />

# Footer
<img width='100%' src='https://res.cloudinary.com/isreal/image/upload/v1702743737/My%20portfolio%20Project/Screenshot_2023-12-16_at_11.21.44_abx99q.png' />
